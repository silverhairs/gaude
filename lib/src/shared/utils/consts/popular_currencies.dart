/// List of popular currencies ordered from the most to the least traded.
/// This list comes from Wikipedia[https://en.wikipedia.org/wiki/Template:Most_traded_currencies}.
const kPopularCurrencies = <Map<String, dynamic>>{
  {
    "code": "USD",
